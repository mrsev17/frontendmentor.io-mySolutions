...
export const Banner = ({ title, text }) => {
  return (
    <div className="relative flex m-auto w-full tablet:mb-8">
      <img
        className="absolute right-[-36px] top-[30px] z-[-1] xl:right-0 md:max-w-[320px] iphone:max-w-[240px] sm-iphone:max-w-[220px]"
        src={HeroRight}
        alt="Hero Left"
      />
      <div className="max-w-sm-content m-auto md:mt-[20rem] iphone:mt-[14rem]">
        <h1 className="pt-[40px] text-64 leading-64 text-dark text-center font-black max-w-[80%] m-auto mb-[34px] tablet:mb-6 tablet:max-w-[60%] tablet:text-48 tablet:leading-48 iphone:text-40 iphone:leading-[44px]">
          {title}
        </h1>
