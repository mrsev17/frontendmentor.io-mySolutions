...
export const MainContent = () => {
  return (
    <section className="w-[723px] mobile:w-auto h-[509px] mobile:h-auto bg-dark mobile:bg-transparent relative flex flex-col justify-end tablet:max-w-[635px]">
      ...
      <p className="text-sm-grey text-18 max-w-[62%] opacity-50 leading-7 mb-10 tablet:max-w-[70%] mobile:max-w-[90%] mobile:text-center mobile:mx-auto mobile:mb-[33px]">
        Upload your audio to Pod with a single click. We’ll then distribute your
        podcast to Spotify, Apple Podcasts, Google Podcasts, Pocket Casts and
        more!
      </p>
      <div className="flex flex-col gap-8 mobile:gap-[42px] mobile:flex-col-reverse">
        <Input />
        <Companies />
      </div>
    </section>
