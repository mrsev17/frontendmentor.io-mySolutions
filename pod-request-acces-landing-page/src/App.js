...
const App = () => {
  return (
    <div className="flex justify-center lg:pl-6 xl:justify-end 2xl:justify-center bg-dark h-screen relative tablet:bg-tablet-hero mobile:bg-mobile-hero mobile:bg-cover tablet:bg-no-repeat tablet:bg-tablet-pos">
      <div className="mobile:bg-dark mobile:h-full mobile:w-full mobile:absolute mobile:opacity-70"></div>
      <div className="max-w-content w-full h-[718px] tablet:px-[39px] relative tablet:static">
        <img
