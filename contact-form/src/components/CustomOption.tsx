    ...
    >
      <div className="grid place-items-center">
        <input
          ...
          } col-start-1 row-start-1 appearance-none shrink-0 w-[20px] h-[20px] border-2 border-mid-grey rounded-full cursor-pointer transition duration-500`}
        />
        <div
          className={`col-start-1 row-start-1 w-[10px] h-[10px] rounded-full transition duration-500 ${
